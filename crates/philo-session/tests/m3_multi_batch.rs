...
#[test]
fn session_m3_001_two_rounds_project_interleaved_in_source_order() {
...
#[test]
fn session_m3_002_new_batch_before_results_complete_is_rejected() {
    let session = SessionId::new("s");
    let turn = TurnId::new("t");
    let store = started_store(&session, &turn);
...
#[test]
fn session_m3_003_result_referencing_previous_batch_is_rejected() {
    let session = SessionId::new("s");
    let turn = TurnId::new("t");
    let store = started_store(&session, &turn);
...
#[test]
fn session_m3_004_duplicate_batch_id_is_rejected() {
    let session = SessionId::new("s");
    let turn = TurnId::new("t");
    let store = started_store(&session, &turn);
...
#[test]
fn session_m3_005_assistant_message_before_latest_results_is_rejected() {
    let session = SessionId::new("s");
    let turn = TurnId::new("t");
    let store = started_store(&session, &turn);
...
#[test]
fn session_m3_006_multi_round_revision_conflict_has_no_partial_write() {
    let session = SessionId::new("s");
    let turn = TurnId::new("t");
    let store = started_store(&session, &turn);
