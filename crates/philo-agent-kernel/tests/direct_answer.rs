//! KERNEL-001: Direct Answer 合法/非法转换.
...
#[test]
fn duplicate_begin_turn_rejected() {
...
#[test]
fn unsupported_tool_call_output_rejected() {
...
#[test]
fn rejected_input_preserves_old_state() {
    let (started, _, _) = begin();
...
#[test]
fn matching_termination_request_fails_turn() {
    let (started, effect_id, _) = begin();
...
#[test]
fn wrong_effect_id_termination_rejected() {
