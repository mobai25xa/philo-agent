...
#[test]
fn m3_zero_rounds_never_allows_tools() {
...
#[test]
fn m3_single_round_matches_m2_trace() {
...
#[test]
fn m3_two_rounds_accumulate_transcript_and_monotonic_ids() {
...
#[test]
fn m3_exhausted_call_rejects_tool_calls_and_preserves_state() {
    let started = begin_with(1);
...
#[test]
fn m3_tool_error_does_not_consume_extra_round() {
    let started = begin_with(2);
    let (first_effect, _, _) = model_effect(&started);
...
#[test]
fn m3_transition_is_deterministic_across_rounds() {
