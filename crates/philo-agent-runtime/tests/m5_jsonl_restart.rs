...
#[test]
fn m5_001_multi_round_loop_succeeds_on_the_jsonl_backend() {
...
#[test]
fn m5_001_model_failure_settles_confirmed_on_the_jsonl_backend() {
    let root = TempRoot::new();
    let sessions = Arc::new(JsonlSessionStore::open(&root.path).expect("open store"));
...
#[test]
fn m5_002_restart_continues_with_the_full_replayed_history() {
    let root = TempRoot::new();
