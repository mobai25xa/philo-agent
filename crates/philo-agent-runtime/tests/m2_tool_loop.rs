...
#[test]
fn integration_m2_001_one_tool_success() {
...
#[test]
fn integration_m2_002_multi_tool_source_order() {
...
#[test]
fn integration_m2_003_tool_errors_continue_to_final_answer() {
...
#[test]
fn integration_m2_004_barrier_b_failure_prevents_tool_execution() {
...
#[test]
fn integration_m2_005_barrier_c_failure_prevents_second_model_call() {
    let model = Arc::new(FakeModel::new([
        ModelScript::tool_call(0, Some("call-1"), Some("echo"), &["{}"]),
...
#[test]
fn integration_m2_006_tool_infrastructure_failure_settles_failed() {
    let model = Arc::new(FakeModel::new([
        ModelScript::tool_call(0, Some("call-1"), Some("echo"), &["{}"]),
        ModelScript::text(&["must not run"]),
    ]));
...
#[test]
fn integration_m2_007_second_tool_call_is_rejected() {
    let model = Arc::new(FakeModel::new([
        ModelScript::tool_call(0, Some("call-1"), Some("echo"), &["{}"]),
...
#[test]
fn integration_m2_008_final_commit_failure_prevents_success() {
    let model = Arc::new(FakeModel::new([
        ModelScript::tool_call(0, Some("call-1"), Some("echo"), &["{}"]),
        ModelScript::text(&["done"]),
    ]));
...
#[test]
fn integration_m2_009_persistent_session_failure_is_unconfirmed() {
    let model = Arc::new(FakeModel::new([
        ModelScript::tool_call(0, Some("call-1"), Some("echo"), &["{}"]),
        ModelScript::text(&["done"]),
    ]));
...
#[test]
fn integration_m2_010_second_turn_reads_prior_tool_exchange() {
    let model = Arc::new(FakeModel::new([
        ModelScript::tool_call(0, Some("call-1"), Some("echo"), &["{}"]),
...
#[test]
fn integration_m2_011_terminal_event_is_emitted_once() {
...
#[test]
fn integration_m2_012_m1_direct_answer_regression() {
