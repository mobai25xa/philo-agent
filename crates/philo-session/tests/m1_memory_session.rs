...
#[test]
fn session_m1_001_empty_context() {
...
#[test]
fn session_m1_002_atomic_turn_start_commit() {
    let store = MemorySessionStore::new();
    let session_id = SessionId::new("session");
...
#[test]
fn session_m1_003_atomic_turn_success_commit() {
    let store = MemorySessionStore::new();
    let session_id = SessionId::new("session");
    let (operation_id, turn_id) = ids(1);
...
#[test]
fn session_m1_004_revision_conflict_has_no_partial_write() {
    let store = MemorySessionStore::new();
    let session_id = SessionId::new("session");
    let (operation_id, turn_id) = ids(1);
    let started = block_on(store.commit(start_transaction(
...
#[test]
fn session_m1_005_invalid_entry_relation_rejected() {
    let store = MemorySessionStore::new();
    let session_id = SessionId::new("session");
    let (_, turn_id) = ids(1);
...
#[test]
fn session_m1_006_duplicate_turn_termination_rejected() {
    let store = MemorySessionStore::new();
    let session_id = SessionId::new("session");
    let (operation_id, turn_id) = ids(1);
...
#[test]
fn session_m1_007_two_completed_turns_project_ordered_messages() {
    let store = MemorySessionStore::new();
    let session_id = SessionId::new("session");
...
#[test]
fn session_m1_008_atomic_turn_failure_commit() {
    let store = MemorySessionStore::new();
    let session_id = SessionId::new("session");
    let (operation_id, turn_id) = ids(1);
    block_on(store.commit(start_transaction(
...
#[test]
fn session_m1_009_failure_cannot_terminate_an_already_terminal_turn() {
    let store = MemorySessionStore::new();
    let session_id = SessionId::new("session");
    let (operation_id, turn_id) = ids(1);
    block_on(store.commit(start_transaction(
