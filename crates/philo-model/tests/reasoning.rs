...
//! reasoning-effort mapping, and usage forwarding.
//!
...
async fn compatible_reasoning_effort_profile_uses_the_common_request_shape() {
    ...
    // v3 cutover: the conservative fallback spelling carries no cache
    // identity and no usage-requesting stream options.
