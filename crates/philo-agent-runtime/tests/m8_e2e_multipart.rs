...
#[test]
fn m8_001_image_turn_completes_a_tool_loop_on_jsonl() {
...
#[test]
fn m8_003_restart_replays_image_context_into_the_next_snapshot() {
    let root = TempRoot::new();
...
#[test]
fn m8_004_missing_artifact_fails_the_next_prompt_as_store_unavailable() {
    let root = TempRoot::new();
