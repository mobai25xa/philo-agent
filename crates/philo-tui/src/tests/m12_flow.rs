//! M12 aggregate replay: one fake host drives session selection, history,
//! confirmation, queueing and the M10/M11 event vocabulary through the same
//! pure state and host-effect layers the terminal driver uses.
